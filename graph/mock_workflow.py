...
from agents.mock_examiner_agent.nodes import create_pattern_statistics_node,create_pattern_analysis_node,create_mock_generator_node,create_mock_validation_node,create_mock_formatter_node
...
def run_mock_workflow(qppr_files):
    ...
    graph_builder.add_node("statistics_analysis",create_pattern_statistics_node())
    ...
    graph_builder.add_node("mock_validation",create_mock_validation_node(llm))
    ...
    graph_builder.add_edge("topic_analysis","statistics_analysis")
    graph_builder.add_edge("statistics_analysis","pattern_analysis")
    graph_builder.add_edge("pattern_analysis","mock_generator")
    graph_builder.add_edge("mock_generator","mock_validation")
    graph_builder.add_edge("mock_validation","mock_formatter")
